...
useSeoMeta({
  ...
  robots: 'index, follow',
  keywords: 'CV template, tailwind resume template, resume template, web resume template, ' + summaryDetail.value.join(' '),
  googlebot: 'CV template, tailwind resume template, resume template, web resume template, ' + summaryDetail.value.join(' '),
